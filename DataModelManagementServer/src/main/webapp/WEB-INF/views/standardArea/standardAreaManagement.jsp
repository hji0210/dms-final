        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-bold">표준 분류 체계 /</span> 관리 </h4>
                    <!-- Title -->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col mb-3">
                                                <div class="input-group">
                                                    <label for="modalCategory" class="input-group-text">표준분류쳬계명 &nbsp;&nbsp;&nbsp; </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col mb-0">
                                                <div class="input-group">
                                                    <label for="modalDescription" class="input-group-text">표준분류체계
                                                        설명</label>
