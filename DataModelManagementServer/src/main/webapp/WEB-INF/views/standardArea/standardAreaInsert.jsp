        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Title -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-bold">표준 분류 체계 /</span> 등록 </h4>
                    <!-- Title -->
                        ...
                        <div class="col-xxl">
                            <div class="card mb-4">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0">표준분류체계 등록</h5>
                                </div>
                                <div class="card-body">
                                    <form>
                                        <div class="row mb-3">
                                            <div class="input-group">
                                                <label for="stdAreaNm" class="input-group-text">표준분류체계명(*)</label>
                                        ...
                                        <div class="row mb-3 ">
                                            <div class="input-group">
                                                <label for="stdAreaDesc" class="input-group-text">표준분류체계 설명</label>
