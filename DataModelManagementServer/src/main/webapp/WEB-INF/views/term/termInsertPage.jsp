                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="input-group">
                                                <input id="searchWord" class="form-select color-dropdown"
                                                       placeholder="입력...">
                                ...
                                <div class="col">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="termDomName"
                                               placeholder="입력..." aria-describedby="floatingInputHelp">
                    ...
                    <div class="modal fade" id="termDomainInsertModal" tabindex="-1" style="display: none;"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalDomainInsertTitle">도메인 조회</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                            ...
                                            <form id="domainForm">
                                                ...
                                                <div class="col-sm-16 mb-3 form-floating">
                                                    <input type="text" class="form-control" id="keyDomName" name="keyDomName"
                                                           placeholder="입력..." aria-describedby="keyDomNameHelp">
                                                ...
                                                <div class="col-sm-16 mb-3">
                                                    ...
                                                    <select class="form-select color-dropdown" id="domGroupId" name="domGroupId">
                                                        <option value="${group.domGroupId}" selected disabled>도메인 그룹</option>
                                                        <c:forEach items="${domainGroups}" var="group">
                                                            <option value="${group.domGroupId}">${group.domGroupId}</option>
                                                        </c:forEach>
                                                    </select>
